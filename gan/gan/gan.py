...
>>>>>>> parent of cc478fb... :bug: fix `RuntimeError: Expected 4-dimensional input for 4-dimensional weight 64 1 4, but got 3-dimensional input of size [1, 64, 64] instead`
            nn.Sigmoid()
        )
